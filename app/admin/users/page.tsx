          ...
          <TabsContent value="freelancers" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Gestiona los freelancers registrados en la plataforma</CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="clients" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Gestiona los clientes registrados en la plataforma</CardDescription>
              </CardHeader>
              <CardContent>
